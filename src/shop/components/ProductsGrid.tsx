...
export const ProductsGrid = ({ products }: Props) => {
  ...
  const [searchParamms, setSearchParams] = useSearchParams();

  const [showFilters, setShowFilters] = useState(false)
  const viewMode = searchParamms.get('viewMode') || 'grid';

  const handleViewModeChange = (mode: 'grid' | 'list') => {
    searchParamms.set('viewMode', mode);
    setSearchParams(searchParamms);
  }
